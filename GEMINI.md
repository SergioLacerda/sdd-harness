# Gemini â€” SDD Governance Bootstrap
...
**trust `.providence/agent-instructions.md` â€” it is authoritative.**

## Quick Reference

| File | Purpose |
|------|---------|
| `.providence/agent-instructions.md` | **START HERE** â€” Complete agent bootstrap |
