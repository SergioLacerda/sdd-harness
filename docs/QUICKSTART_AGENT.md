...
6. **Anti-Pattern**: Avoid [Symptom Fixing](./cognition/anti-patterns/SYMPTOM_FIXING.md).

**Directive:** Checkpoint every 30 mins. Validate before completion. Never load full mandate docs unless SELF-EVALUATION is not confident.
