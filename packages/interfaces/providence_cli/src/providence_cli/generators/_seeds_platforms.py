...
See `.providence/source/` for complete specification.
...
3. Validate against `.providence/compiled/` specifications
4. Use compiled artifacts via: `providence ask --full "<question>"`

## Key Resources
- Compiled governance: `.providence/compiled/audit/metadata-core.json`
- Specifications: `.providence/source/`
...
- **Governance Model**: Compiled artifacts in `.providence/compiled/`
...
```
Framework:
    |-- .providence/                 # Compiled governance artifacts
