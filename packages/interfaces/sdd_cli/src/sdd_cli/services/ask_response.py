"""ask_response — final JSON/text response emission for `sdd ask`.

Builds the dossier lines (when requested) and emits the JSON or text
response to stdout. Dossier helpers are injected as callables since
they are thin wrappers owned by `commands/_ask_backend.py`.
"""
