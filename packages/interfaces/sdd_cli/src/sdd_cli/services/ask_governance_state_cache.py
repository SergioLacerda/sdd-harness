...
_STATE_MTIME_CACHE: dict[str, int] = {}
...
def _load_governance_state(workspace_root: Path) -> dict[str, Any]:
    ...
    if state_path.exists():
        try:
            ...
            _STATE_MTIME_CACHE[key] = state_path.stat().st_mtime_ns
        except Exception:
            data = {}
    else:
        _STATE_MTIME_CACHE[key] = 0
    ...
    *,
    ...
    with open(lock_path, "a+", encoding="utf-8") as lock_fh:
        ...
        try:
            ...
            current_mtime = state_path.stat().st_mtime_ns if state_path.exists() else 0
