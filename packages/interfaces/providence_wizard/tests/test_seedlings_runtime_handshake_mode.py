...
class TestHandshakeModeSeedlingSelection:
    @patch(
        "providence_wizard.orchestration.wizard.seedlings_runtime.SeedlingsOrchestrator"
    )
    @patch("providence_wizard.orchestration.wizard.seedlings_runtime.GovernanceLoader")
