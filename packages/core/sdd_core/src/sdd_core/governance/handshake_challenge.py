...
class HandshakeChallenge:
    ...
    def _resolve_signature_status(self) -> str:
        ...
        `sdd_runtime.signatures.validate_artifact_signature`, the same
    ...
    def _resolve_budget(self) -> dict[str, Any]:
        ...
        challenge-generation time (`sdd_runtime.budget.TokenBudget` is
    ...
    def generate_challenge(
        ...
        # (e.g. `sdd governance handshake --response`) can bind the eventual
