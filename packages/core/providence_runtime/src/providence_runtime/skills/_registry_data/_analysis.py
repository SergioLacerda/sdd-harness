...
_ANALYSIS_SKILLS: dict[str, SkillDefinition] = {
    "sdd-diagnose": SkillDefinition(
        ...
        allowed_tools=["providence doctor run", "providence runtime status --force"],
        cli_fallback=["providence doctor run", "providence runtime status --force"],
    ...
    "sdd-validate-governance": SkillDefinition(
        ...
        outcomes=["policy_result", "next_actions"],
        allowed_tools=["providence governance validate", "providence runtime status"],
        cli_fallback=["providence governance validate", "providence runtime status"],
        required_permissions=["workspace-read"],
        risk_score="medium",
    ...
    "sdd-review-architecture": SkillDefinition(
        ...
        outcomes=["policy_result", "next_actions"],
        allowed_tools=["providence governance score --verbose"],
        cli_fallback=["providence governance score --verbose"],
        required_permissions=["workspace-read"],
        capability_id="review_architecture",
        risk_score="high",
    ...
    "sdd-harness": SkillDefinition(
        ...
        cli_fallback=["providence runtime status --force"],
        required_permissions=["workspace-read"],
        risk_score="low",
