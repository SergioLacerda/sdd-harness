...
from providence_core.governance.spec_bootstrapper import SourceSpecBootstrapper
...
def _make_orchestrator(tmp_path: Path) -> Any:
    ...
    with patch(
        "providence_core.governance_orchestrator.get_sdd_paths", return_value=mock_paths
    ):
