...
# Parsed by providence_wizard.orchestration.wizard.spec_parser.GuidelinesDslParser
# Ships as providence_core package data and is the default bootstrap source for
# `sdd install --wizard`.
