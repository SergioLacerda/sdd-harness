...
# internals), SDD_COMPLIANCE_EVENTS_PATH (providence ask telemetry), SDD_TELEMETRY_PATH
# (providence telemetry/providence audit commands) — each read by its own call site with no
