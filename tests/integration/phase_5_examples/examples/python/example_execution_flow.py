...
class TestExecutionFlow:
    ...
    def _ensure_initialized(self) -> None:
        ...
        if (
            hasattr(self, "framework_root")
            and hasattr(self, "execution_dir")
    ...
    def test_canonical_layer(self) -> None:
    ...
    def test_guides_layer(self) -> None:
    ...
    def test_runtime_layer(self) -> None:
        ...
        for runtime_file in runtime_files:
            ...
            if path.exists():
                ...
                lines = read_text_utf8(path).count("\n")
    ...
    def test_ai_first_design(self) -> None:
